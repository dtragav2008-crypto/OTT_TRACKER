...
const AuthPage = () => {
    ...
    return (
        <div className="relative min-h-screen bg-dark-900 flex items-center justify-center px-4 py-12 overflow-hidden">
            <PolygonBackground />
            ...
            >
                ...
                <span className="font-semibold">OTT Tracker</span>
            </motion.button>
            ...
            >
                <div className="cyber-card p-8 md:p-10">
                    ...
                    <div className="text-center mb-8">
                        <div className="w-14 h-14 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-accent to-accent-dark flex items-center justify-center shadow-glow">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.99 }}
                            className="cyber-btn w-full py-3.5 flex items-center justify-center gap-2"
                        >
                    ...
                    <div className="relative my-7">
                        ...
                        <div className="relative flex justify-center">
                            <span className="bg-dark-800 px-3 text-xs text-gray-600">or continue with</span>
                        </div>
                    </div>

                    {/* Social */}
                    <div className="grid grid-cols-2 gap-3">
                        <button className="flex items-center justify-center gap-2 py-2.5 rounded-lg glass hover:border-accent/30 transition-all text-sm font-medium">
